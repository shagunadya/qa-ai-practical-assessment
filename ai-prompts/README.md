...
- Templates marked **partial** in the submission checklist (e.g. full 21-test green run) reflect items still open — see [`documentation-and-summary.md`](documentation-and-summary.md) and [`docs/limitations-and-gaps.md`](../docs/limitations-and-gaps.md).
